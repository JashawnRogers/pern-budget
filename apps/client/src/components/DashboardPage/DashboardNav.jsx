  ...
  return (
    <header className='sticky top-0 bg-white shadow-sm z-50'>
      <nav className='w-full px-4 py-4 flex justify-between items-center relative flex-wrap'>
        <NavLink to='/dashboard' className='flex items-center gap-2 mr-5 sm:gap-3'>
          <img
            src={logo}
            className='w-28 md:w-52 object-contain align-middle'
            alt='SpendWise logo'
          />
          <h1 className='-ml-10 md:-ml-16 montesserat-400 text-2xl sm:text-3xl md:text-3xl leading-tight'>
            SpendWise
          </h1>
        </NavLink>
